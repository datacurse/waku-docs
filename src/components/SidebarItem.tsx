...
interface SidebarItemData {
  title: string;
  icon?: IconType | undefined; // Explicitly allow undefined
...
// Updated interface for CollectionHeader
interface CollectionHeaderProps {
  icon?: IconType | undefined; // Explicitly allow undefined
  title: string;
}

// Updated interface for ItemIcon
interface ItemIconProps {
  icon?: IconType | undefined; // Explicitly allow undefined
  isActive: boolean;
}

const CollectionHeader: React.FC<CollectionHeaderProps> = ({ icon: Icon, title }) => (
...
const ItemIcon: React.FC<ItemIconProps> = ({ icon: Icon, isActive }) => {
  if (!Icon) return null;
  return (
    <Icon
      className={cn(
...
export function SidebarItem({ item, path = '', depth = 0 }: SidebarItemProps): JSX.Element {
